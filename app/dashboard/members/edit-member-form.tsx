...
export function EditMemberForm({ member, children }: { member: Member, children: React.ReactNode }) {
  const [open, setOpen] = useState(false);
  const updateMemberWithId = updateMember.bind(null, member.id);
  const [state, formAction] = useFormState<FormState, FormData>(updateMemberWithId, initialState);
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <form ref={formRef} action={formAction} className="grid gap-4 py-4">
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="nin" name="nin" defaultValue={member.nin} className="col-span-3" />
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="occupation" name="occupation" defaultValue={member.occupation} className="col-span-3" />
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input id="district" name="district" defaultValue={member.district} className="col-span-3" />
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Select name="incomeBracket" defaultValue={member.incomeBracket}>
